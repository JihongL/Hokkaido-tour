      ...
      <div className="space-y-3">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-base text-red-600">119 바로 전화</p>
          </div>
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-base text-red-600">110 바로 전화</p>
          </div>
          <span className="text-2xl font-bold text-white bg-red-500 px-5 py-3 rounded-2xl">📞</span>
        </a>
      ...
      {showAll && (
        <div className="space-y-4 fade-in">
          ...
          <div className="card-base">
            ...
            <div className="space-y-2.5">
              {[
                ...
                { label: "토야코 병원", number: "+81-142-75-2211", note: "Lake Toya area" },
              ].map((item, i) => (
                <a
                  key={i}
          ...
          <div className="card-base">
            ...
            <div className="space-y-2.5">
              {[
                { label: "주일 한국대사관", number: "+81-3-3452-7611" },
                { label: "삿포로 한국총영사관", number: "+81-11-218-0288" },
              ].map((item, i) => (
                <a
                  key={i}
                  href={`tel:${item.number.replace(/[^+\d]/g, "")}`}
          ...
          <div className="card-base">
            ...
            <div className="space-y-2.5">
              {[
                { label: "미야비테이 (시코쓰호)", number: "+81-123-25-2424" },
