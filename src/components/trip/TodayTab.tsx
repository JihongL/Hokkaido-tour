...
const days: DayData[] = [
  ...
  {
    day: 2, date: "5월 4일", weekday: "월", title: "곰목장 & 도야호",
    location: "노보리베츠 → 도야호",
    schedule: [
      ...
      { time: "10:30", activity: "해안도로 드라이브", detail: "노보리베츠 → 무로란 · 경치 좋은 루트", type: "move" },
      { time: "11:30", activity: "점심", detail: "무로란 현지 식당", type: "food" },
      { time: "13:00", activity: "지큐미사키 (지구곶)", detail: "태평양 절경 전망대", type: "activity" },
      { time: "13:30", activity: "톳카리쇼 전망대", detail: "해안 절벽 절경 · 지구곶에서 차 10분", type: "activity" },
      { time: "14:00", activity: "하쿠초 대교", detail: "동일본 최대 현수교 1,380m · 차로 통과", type: "move" },
      { time: "14:30", activity: "우스산 로프웨이", detail: "활화산 전망대 + 쇼와신잔 조망", type: "activity" },
      { time: "16:00", activity: "토야 코한 테이 체크인", detail: "도야호 온천 호텔 (2박) · 호수뷰 화양실", type: "stay" },
      { time: "19:00", activity: "석식", detail: "호텔 뷔페", type: "food" },
    ...
    meals: ["조식: 호텔 뷔페", "점심: 무로란 현지 식당", "저녁: 토야 코한 테이 호텔 뷔페"],
    parentTip: "알찬 하루! 곰목장, 지구곶+톳카리쇼 절경, 하쿠초대교, 우스산까지. 밤에는 불꽃놀이!",
  ...
  },
  {
    ...
    schedule: [
      { time: "08:00", activity: "조식", detail: "호텔 뷔페", type: "food" },
      { time: "09:30", activity: "소베쓰 공원", detail: "매화 만개! 도야호 조망 · 무료 · 차 15분", type: "activity" },
      { time: "10:30", activity: "사이로 전망대", detail: "도야호+우스산+요테이산 파노라마 · 무료 · 차 10분", type: "activity" },
      { time: "11:30", activity: "레이크힐 농장", detail: "목장 젤라토 · 요테이산 뷰 · 무료 · 차 5분", type: "activity" },
      { time: "12:30", activity: "점심", detail: "현지 식당", type: "food" },
      { time: "14:00", activity: "호숫가 산책", detail: "도야호 조각공원 · 온천가 앞 구간 · 무료", type: "activity" },
    ...
    parentTip: "소베쓰 매화 감상 후 전망대, 목장 젤라토! 오후는 여유롭게 호숫가 산책과 온천.",
...
const dayRoutes = [
  ...
  },
  {
    ...
    stops: [
      ...
      { name: "톳카리쇼", emoji: "🏖️", lat: 42.3100, lng: 140.9760 },
      { name: "하쿠초대교", emoji: "🌉", lat: 42.3380, lng: 140.9550 },
