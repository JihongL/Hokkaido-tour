...
const days: DayData[] = [
  {
    day: 1, date: "5월 3일", weekday: "일", title: "신치토세 도착 & 시코쓰호",
    location: "시코쓰호",
    schedule: [
      { time: "10:35", activity: "인천 출발 (KE765)", type: "flight" },
      { time: "13:25", activity: "신치토세공항 도착", type: "flight" },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:30", activity: "온천 체험", detail: "노보리베츠 공중 온천", type: "activity" },
      { time: "15:00", activity: "도야호로 이동", detail: "차로 약 40분", type: "move" },
      { time: "16:00", activity: "도야호 호반 산책", detail: "칼데라 호수 전망", type: "activity" },
  ...
  {
    day: 3, date: "5월 5일", weekday: "화", title: "도야호 주변 관광",
    location: "도야호",
    schedule: [
      { time: "08:00", activity: "조식", detail: "호텔 뷔페", type: "food" },
      { time: "10:00", activity: "우스산 로프웨이", detail: "활화산 전망대 (미확정)", type: "placeholder" },
      { time: "12:00", activity: "점심", detail: "일정 미확정 — 추후 업데이트 예정", type: "placeholder" },
      { time: "14:00", activity: "도야호 주변 자유시간", detail: "일정 미확정 — 추후 업데이트 예정", type: "placeholder" },
      { time: "18:00", activity: "저녁 식사", detail: "호텔 또는 주변 식당", type: "food" },
      { time: "20:00", activity: "온천 & 휴식", type: "activity" },
    ],
    meals: ["조식: 호텔", "점심: 미정", "저녁: 호텔 또는 주변"],
    parentTip: "여유로운 하루. 컨디션에 맞춰 자유롭게!",
    preparation: ["편한 옷", "카메라"],
  },
  {
    day: 4, date: "5월 6일", weekday: "수", title: "귀국",
    location: "신치토세",
    schedule: [
      { time: "08:00", activity: "조식 & 체크아웃", detail: "토야 코한 테이", type: "food" },
      { time: "10:00", activity: "신치토세로 이동", detail: "차로 약 2시간", type: "move" },
      { time: "12:00", activity: "공항 주변 점심", detail: "신치토세공항 라멘 거리 추천", type: "food" },
      { time: "14:30", activity: "렌터카 반납", detail: "혼다렌탈리스 라벤더점", type: "move" },
      { time: "16:20", activity: "신치토세 출발 (KE770)", type: "flight" },
      { time: "19:30", activity: "인천 도착", type: "flight" },
    ],
    meals: ["조식: 호텔", "점심: 공항 라멘", "저녁: 기내식"],
    parentTip: "마지막 날! 공항에서 기념품 쇼핑 시간 확보. 로이스 초콜릿 추천!",
