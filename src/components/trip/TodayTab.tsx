...
const days: DayData[] = [
  {
    ...
    meals: ["점심: 기내식 또는 공항에서 간단히", "저녁: 하나유라 료칸 식사"],
    ...
    options: [
      {
        ...
        schedule: [
          ...
          { time: "12:30", activity: "점심", detail: "카니오 (게요리 · 12:30 예약)", type: "food", googleMapsUrl: "https://maps.app.goo.gl/7uygBSkuvuVn8hyW8" },
          { time: "14:00", activity: "오로후레 고개 드라이브", detail: "도도2호 산악도로 · 약 50분 · 산악 파노라마 뷰포인트 정차", type: "move" },
          { time: "15:00", activity: "소베쓰 공원", detail: "매화 만개! 도야호 조망 · 무료", type: "activity", googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=壮瞥公園" },
          { time: "15:45", activity: "토야 코한 테이 체크인", detail: "도야호 온천 호텔 (2박) · 호수뷰 화양실", type: "stay" },
          { time: "16:15", activity: "우스산 로프웨이", detail: "활화산 전망대 + 쇼와신잔 조망", type: "activity", googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=有珠山ロープウェイ" },
          { time: "17:30", activity: "호숫가 산책", detail: "도류노유 족욕 · 조각공원 · 무료", type: "activity" },
        ...
        meals: ["조식: 하나유라 조식", "점심: 카니오 (게요리)", "저녁: 토야 코한 테이 호텔 뷔페"],
        parentTip: "곰목장 후 카니오에서 게요리 점심! 오로후레 고개 산악 드라이브로 소베쓰 매화 감상, 우스산 로프웨이.",
      ...
      },
      {
        ...
        emoji: "🌊",
        label: "바다뷰 드라이브",
        subtitle: "해안선 · 지구곶 · 무로란 경유",
        location: "노보리베츠 → 무로란 → 도야호",
        stops: [
          { name: "하나유라", emoji: "🏨", lat: 42.4940, lng: 141.1550 },
          { name: "곰목장", emoji: "🐻", lat: 42.4850, lng: 141.1610 },
          { name: "카니오", emoji: "🦀", lat: 42.4779, lng: 141.2423 },
        ...
        schedule: [
          ...
          { time: "10:30", activity: "곰목장", detail: "노보리베츠 곰목장 · 로프웨이 탑승", type: "activity", googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=のぼりべつクマ牧場" },
          { time: "12:30", activity: "점심", detail: "카니오 (게요리 · 12:30 예약)", type: "food", googleMapsUrl: "https://maps.app.goo.gl/7uygBSkuvuVn8hyW8" },
          { time: "14:00", activity: "무로란 방면 이동", detail: "해안도로 드라이브 · 약 30분", type: "move" },
          { time: "14:30", activity: "지구곶 전망대", detail: "태평양 270도 파노라마 · 무료 · 지구가 둥글다!", type: "activity", googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=地球岬展望台" },
          { time: "15:30", activity: "도야호 방면 이동", detail: "무로란 → 도야호 · 약 1시간", type: "move" },
          { time: "16:30", activity: "토야 코한 테이 체크인", detail: "도야호 온천 호텔 (2박) · 호수뷰 화양실", type: "stay" },
          { time: "17:30", activity: "호숫가 산책", detail: "도류노유 족욕 · 조각공원 · 무료", type: "activity" },
          { time: "19:00", activity: "석식", detail: "호텔 뷔페", type: "food" },
          { time: "20:00", activity: "온천", detail: "토야 코한 테이 온천", type: "activity" },
          { time: "20:45", activity: "도야호 불꽃놀이", detail: "호반에서 관람 · 20:45~21:05", type: "activity" },
        ...
        meals: ["조식: 하나유라 조식", "점심: 카니오 (게요리)", "저녁: 토야 코한 테이 호텔 뷔페"],
        parentTip: "곰목장 후 카니오에서 게요리 점심, 해안 드라이브로 지구곶 절경! 태평양 수평선을 눈에 담고 도야호로.",
        preparation: ["온천 타올", "카메라", "편한 신발", "바람막이 (해안 바람)"],
      },
    ],
  },
  {
    ...
    parentTip: "오전은 여유롭게, 나카무라에서 일식 코스 점심! 오후는 레이크힐 젤라토와 미니후지 요테이산 뷰.",
...
const dayRoutes = [
  ...
  },
  {
    ...
    stops: [
      { name: "토야 코한 테이", emoji: "🏨", lat: 42.5659, lng: 140.8259 },
      { name: "나카무라", emoji: "🍽️", lat: 42.5685, lng: 140.8037 },
