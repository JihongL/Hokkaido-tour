    ...
    options: [
      {
        ...
        stops: [
          ...
          { name: "온천시장", emoji: "🍽️", lat: 42.4933, lng: 141.1540 },
        ...
        parentTip: "곰목장 후 온천시장에서 해산물 점심! 오로후레 고개 산악 드라이브로 소베쓰 매화 감상, 우스산 로프웨이.",
      ...
      },
      {
        ...
        stops: [
          { name: "하나유라", emoji: "🏨", lat: 42.4940, lng: 141.1550 },
          { name: "곰목장", emoji: "🐻", lat: 42.4850, lng: 141.1610 },
          { name: "노보리베츠 시내", emoji: "🍽️", lat: 42.4130, lng: 141.1070 },
        ...
        parentTip: "곰목장 후 시내에서 점심, 해안 드라이브로 지구곶 절경! 태평양 수평선을 눈에 담고 도야호로.",
