...
const rules = [
  { num: "하나", text: "운전자에게 졸려? 금지" },
  { num: "둘", text: "춥다 금지 (옷 많이 싸세요)" },
  { num: "셋", text: "온천에서 수건 물에 담그기 금지" },
  { num: "넷", text: "아직 멀었냐 금지" },
  { num: "다섯", text: "이거 한국 돈으로 얼마냐 금지" },
  { num: "여섯", text: "렌터카 좌측통행 무서워 금지" },
  { num: "일곱", text: "밥이 작다 금지 (일본식이에요)" },
  { num: "여덟", text: "온천 너무 뜨겁다 금지" },
  { num: "아홉", text: "호텔 체크인 안 되냐 금지" },
  { num: "열", text: "돈 아깝다 금지" },
];
...
const SignaturePad = forwardRef<SignaturePadHandle, SignaturePadProps>(
  ...
  useEffect(() => {
    ...
    c.ctx.lineWidth = 2.5;
    c.ctx.strokeStyle = "hsl(270, 15%, 15%)";
  }, [getCtx]);
...
async function buildPledgeImage(name: string, signatureDataUrl: string): Promise<string | null> {
  ...
  ctx.fillText("우리 가족 홋카이도 여행 10계명", w / 2, pad + 22);
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      <div
        ...
        style={{ backgroundImage: "url('/hokkaido_bg.webp')" }}
      />
