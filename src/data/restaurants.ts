...
export const restaurants: Restaurant[] = [
  ...
  // ============================================================
  {
    ...
    nameKr: "카니오 (かに王)",
    area: "noboribetsu",
    tabelogUrl: "https://tabelog.com/hokkaido/A0108/A010802/1052986/",
    rating: 3.31,
    reviewCount: 38,
    genre: "게요리 (蟹料理)",
    representativeMenu: "활털게 즉석 삶기",
    address: "北海道白老郡白老町字竹浦113-13",
    phone: "0144-87-4575",
    businessHours: "09:00–17:00 (L.O. 16:00)",
    closedDays: "부정기 휴무",
    totalSeats: 0,
    privateRoom: "",
    seatType: "",
    ...
    parking: "",
    priceRange: "¥2,000–2,999 (방문객 평균 ¥5,000~)",
    googleMapsUrl: "https://maps.app.goo.gl/7uygBSkuvuVn8hyW8",
    seniorNote: "곰목장에서 동쪽 ~20분 (시라오이 다케우라). 식사 후 도야호로 서진 ~60분. 10명 12:30 예약 확정",
    lat: 42.4779,
    lng: 141.2423,
    gwStatus: "confirmed",
    familyFriendly: true,
